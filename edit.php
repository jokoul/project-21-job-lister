...
if(isset($_POST['submit'])){
    ...
    if($job->update($job_id, $data)){
        ...
        redirect('index.php','Your job has been updated', 'success');//second parameter is a message we want to display
    }else{
...
$template = new Template('templates/job-edit.php');//take as parameter the path to the template we want
